...
const firstNamesM = ["أحمد", "محمد", "يوسف", "عمر", "خالد", "زيد", "كريم", "مالك", "بشار", "سامي", "أنس", "حمزة"];
const firstNamesF = ["مريم", "فاطمة", "ليان", "سلمى", "نور", "رزان", "هبة", "دانا", "جنى", "لينا", "آية", "سارة"];
const families = ["العبد الله", "أبو راس", "الخطيب", "حمدان", "المصري", "درويش", "الحلبي", "السعدي", "قاسم", "النجار", "شاهين", "زيدان"];

export const grades = ["الصف الأول", "الصف الثاني", "الصف الثالث", "الصف الرابع", "الصف الخامس", "الصف السادس", "الصف السابع", "الصف الثامن", "الصف التاسع", "الصف العاشر", "الصف الحادي عشر", "الصف الثاني عشر"];
...
export const subjectNames = ["الرياضيات", "اللغة العربية", "اللغة الإنجليزية", "العلوم", "الفيزياء", "الكيمياء", "الأحياء", "التربية الإسلامية", "الاجتماعيات", "الحاسوب", "الرياضة", "الفنون"];
...
export const announcements: Announcement[] = [
  { id: "AN-1", title: "الاجتماع الفصلي لأولياء الأمور", body: "يُعقد اجتماع أولياء الأمور لمناقشة نتائج الفصل الأول في قاعة المدرسة الكبرى.", date: "2026-08-06", audience: "أولياء الأمور", type: "حدث" },
  { id: "AN-2", title: "بدء امتحانات الفصل الثاني", body: "تبدأ امتحانات الفصل الثاني للصفوف من السابع حتى الثاني عشر وفق الجدول المعلن.", date: "2026-08-10", audience: "الطلاب والمعلمون", type: "إعلان" },
  { id: "AN-3", title: "رحلة علمية إلى متحف العلوم", body: "رحلة لطلاب الصفوف الخامس والسادس، الرجاء تسليم موافقة ولي الأمر.", date: "2026-08-14", audience: "الصف الخامس والسادس", type: "حدث" },
  { id: "AN-4", title: "تذكير بسداد الرسوم المتأخرة", body: "نرجو من أولياء الأمور المتأخرين سداد الأقساط قبل نهاية الشهر.", date: "2026-08-03", audience: "أولياء الأمور", type: "تنبيه" },
  { id: "AN-5", title: "يوم رياضي مفتوح", body: "منافسات رياضية بين الشُعب في ملعب المدرسة مع جوائز للفرق الفائزة.", date: "2026-08-20", audience: "جميع الطلاب", type: "حدث" },
];

export const periods = ["الحصة ١", "الحصة ٢", "الحصة ٣", "الحصة ٤", "الحصة ٥", "الحصة ٦", "الحصة ٧"];
...
export const assignments: Assignment[] = [
  { id: "ASG-1", title: "حل تمارين الوحدة الرابعة", subject: "الرياضيات", grade: "الصف التاسع", due: "2026-08-05", submitted: 22, total: 28, status: "مفتوح" },
  { id: "ASG-2", title: "تحليل قصيدة المتنبي", subject: "اللغة العربية", grade: "الصف العاشر", due: "2026-08-04", submitted: 25, total: 25, status: "قيد التصحيح" },
  { id: "ASG-3", title: "تقرير تجربة الكثافة", subject: "الفيزياء", grade: "الصف الحادي عشر", due: "2026-08-08", submitted: 12, total: 24, status: "مفتوح" },
  { id: "ASG-4", title: "Essay: My Future Career", subject: "اللغة الإنجليزية", grade: "الصف الثامن", due: "2026-07-29", submitted: 27, total: 27, status: "مغلق" },
  { id: "ASG-5", title: "بحث عن دورة الماء", subject: "العلوم", grade: "الصف السادس", due: "2026-08-11", submitted: 9, total: 26, status: "مفتوح" },
  { id: "ASG-6", title: "خريطة ذهنية للدولة الأموية", subject: "الاجتماعيات", grade: "الصف السابع", due: "2026-08-07", submitted: 18, total: 30, status: "مفتوح" },
];
...
export const messages: Message[] = [
  { id: "M-1", from: "أ. سلمى الخطيب", role: "معلمة الرياضيات", preview: "أحمد يُبدي تحسناً واضحاً في حل المسائل هذا الأسبوع.", time: "قبل ١٠ د", unread: true },
  { id: "M-2", from: "خالد حمدان", role: "ولي أمر", preview: "هل يمكن تحديد موعد لمناقشة نتائج الفصل الأول؟", time: "قبل ساعة", unread: true },
  { id: "M-3", from: "إدارة المدرسة", role: "إدارة", preview: "تم تحديث جدول الحصص للصف التاسع بدءاً من الأحد.", time: "أمس", unread: false },
  { id: "M-4", from: "أ. عمر المصري", role: "معلم العلوم", preview: "الرجاء متابعة تسليم تقرير التجربة قبل الخميس.", time: "قبل يومين", unread: false },
];
