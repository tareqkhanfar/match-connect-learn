...
export const navItems: NavItem[] = [
  ...
  // The five specialist files. Each is its own screen: a nurse and a speech
  // therapist keep different records, and one shared list would mean each
  // reading past the other's.
  {
    label: "نماذج التمريض",
    to: "/app/forms/nursing",
    icon: Stethoscope,
    roles: ["admin", "secretary", "teacher"],
  ...
  {
    label: "نماذج الإرشاد",
    to: "/app/forms/counselling",
    icon: HeartHandshake,
    roles: ["admin", "secretary", "teacher"],
    group: "النماذج المتخصصة",
  },
  {
    label: "نماذج الاحتياجات الخاصة",
    to: "/app/forms/special_needs",
    icon: Accessibility,
    roles: ["admin", "secretary", "teacher"],
    group: "النماذج المتخصصة",
  },
  {
    label: "نماذج صعوبات التعلم",
    to: "/app/forms/learning_difficulties",
    icon: BookOpenCheck,
    roles: ["admin", "secretary", "teacher"],
    group: "النماذج المتخصصة",
  },
